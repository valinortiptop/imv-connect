...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "navPurchaseNeeds",       label: "Compras",              url: "/admin/compras",              icon: ClipboardList, exact: true },
      { key: "navComprasPlaneacion",   label: "Planeación",           url: "/admin/compras/planeacion",   icon: ClipboardCheck },
      { key: "navComprasOrdenes",      label: "Órdenes",              url: "/admin/compras/ordenes",      icon: FileText },
      { key: "navComprasProveedores",  label: "Proveedores",          url: "/admin/compras/proveedores",  icon: Building },
